...
const ViewSupplyDetails = () => {
    ...
    return (
        <div>
            {isLoading ? (
                <div className="min-h-[80vh] flex flex-col sm:flex-row gap-4 w-full sm:px-8 py-8 pb-2">
                    <div className="skeleton h-48 sm:h-96 w-full"></div>
                ...
                <section className="text-gray-700 body-font overflow-hidden bg-white dark:bg-gray-800">
                    <div className="py-8 mx-auto">
                        <div className="w-full mx-auto flex flex-wrap">
                            <div className="w-full sm:w-1/2 h-full sm:h-[30rem]">
                            ...
                            <div className="md:w-1/2 w-full lg:pl-10 lg:py-6 mt-3 sm:mt-6 lg:mt-0
