        ...
        <section className="mb-10 sm:mb-24">
            <div className="py-4 mx-auto flex flex-wrap">
                <div className="flex-1 flex flex-wrap  my-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
                    <div className='sm:mb-4 flex flex-col items-center sm:items-start w-full dark:text-gray-100'>
                    ...
                    <div className="stats shadow w-full flex flex-col md:flex-row justify-center items-center dark:bg-gray-700">
                        <div className="stat w-full">
                            <div className="stat-figure text-accent">
                                <FaPeopleCarry size={30} />
                            </div>
                            <div className="stat-title dark:text-gray-100">Total Communities</div>
                            <div className="stat-value text-info">65+</div>
                            <div className="stat-desc dark:text-gray-100">Growing 21% more this year</div>
                        </div>
                        <div className="stat w-full">
                            <div className="stat-figure text-accent">
                                <GiFruitBowl size={30} />
                            </div>
                            <div className="stat-title dark:text-gray-100">Meals Distributed</div>
                            <div className="stat-value text-info">100K+</div>
                            <div className="stat-desc dark:text-gray-100">The number is growing everyday</div>
                        </div>
                        <div className="stat w-full">
                            <div className="stat-figure text-accent">
                                <GiFirstAidKit size={30} />
                            </div>
                            <div className="stat-title dark:text-gray-100">Hygiene Kit</div>
                            <div className="stat-value text-info">50K+</div>
                            <div className="stat-desc dark:text-gray-100">Making hygiene a priority</div>
                        </div>
                    </div>
                </div>
