                ...
                <div className="px-4 md:px-6">
                    <div className="flex flex-col justify-center items-center space-y-12 text-center">
                        <div className="space-y-2">
                            <div className="inline-block rounded-lg bg-teal-100 px-3 py-1 text-sm">Our Mission</div>
                            <h2 className="text-2xl text-center font-bold tracking-tighter sm:text-5xl">Providing for those in need.</h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-8 sm:gap-0">
                            ...
                            <div className="space-y-2 flex flex-col items-center sm:justify-start sm:items-start">
                                <div className="inline-block rounded-lg bg-teal-100 px-3 py-1 text-sm w-max">
                                    Our Approach
                                </div>
                                <p className="max-w-[600px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed text-center sm:text-left">
