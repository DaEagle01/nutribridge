        ...
        <div className="bg-white dark:bg-gray-800 h-[100vh] w-full md:p-4 rounded-lg flex justify-between">
            <section className="relative flex flex-wrap lg:h-screen w-full">
                ...
                <div className="w-full md:w-1/2 px-2 md:px-4 pt-0 pb-12">
                    <div className='px-4 md:px-8 pt-4 pb-12 shadow dark:shadow-xl w-full h-max'>
                        <h1 className='text-xl md:text-3xl font-bold text-gray-700 dark:text-gray-100 text-center mb-4 md:mb-0'>
                            Create supply
                        </h1>
                        <form method="dialog" onSubmit={handleSubmit} className="space-y-2">
                            <label className="form-control w-full">
                                <div className="label py-1">
                                    <span className="label-text font-bold dark:text-gray-100">Item name</span>
                                </div>
                                <input
                                    name="title"
                                    ...
                                    className="input input-bordered w-full px-2 h-10 dark:bg-gray-200"
                                />
                            </label>
                            <label className="form-control w-full">
                                <div className="label py-1">
                                    <span className="label-text font-bold dark:text-gray-100">Image</span>
                                </div>
                                <input
                                    name="image"
                            ...
                            <label className="form-control w-full">
                                <div className="label py-1">
                                    <span className="label-text font-bold dark:text-gray-100">Item category name</span>
                                </div>
                                <input
                                    name="category"
                            ...
                            <label className="form-control w-full">
                                <div className="label py-1">
                                    <span className="label-text font-bold dark:text-gray-100">Item quantity</span>
                                </div>
                                <input
                                    name="quantity"
                            ...
                            <label className="form-control w-full">
                                <div className="label py-1">
                                    <span className="label-text font-bold dark:text-gray-100">Item description</span>
                                </div>
                                <textarea
                                    name="description"
                                    ...
                                    className="textarea textarea-bordered textarea-lg w-full px-2 pt-0  dark:bg-gray-200"
                                />
                            </label>
                            <button type="submit" className="btn w-full text-white bg-teal-500 dark:bg-teal-600 dark:hover:bg-teal-700 border-0 py-2 px-6 focus:outline-none hover:bg-teal-600 rounded" style={{ marginTop: "2rem" }}>
                                Create Item
                            </button>
                        </form>
                    </div>
